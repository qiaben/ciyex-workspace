...
export class EncounterEditor extends EditorPane {
	...
	private static _defaultSections(): SectionDef[] {
		return [
			...
			{ key: 'past-medical-history', title: 'Past Medical / Surgical History', columns: 1, visible: true, fields: [{ key: 'pmh_conditions', label: 'Medical Conditions', type: 'textarea' }, { key: 'pmh_allergies', label: 'Allergies', type: 'textarea' }] },
