...
// AppointmentsSidebarPane no longer registered — Appointments activity-bar
// entry is hidden. Import is kept here as a documentation pointer to the pane
// implementation in case the entry is re-enabled.
...
// Appointments activity-bar entry hidden — the Schedule (Calendar) container
// already surfaces today's appointments, and the patient snapshot exposes the
...
// Appointments view registration disabled — see APPOINTMENTS_CONTAINER above.
